//! Stage-8 recovered bootstrap/relocation behavior for RAMBOOT v1.06.
...
pub const POST_RELOCATION_BRANCH:u64=0x0300_5A44;
#[cfg(test)]mod tests{use super::*;#[test]fn map(){assert_eq!(runtime_address(0x800),Some(0x0300_1000));assert_eq!(runtime_address(0x5244),Some(POST_RELOCATION_BRANCH));}}
