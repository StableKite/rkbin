...
#[cfg(test)]mod tests{use super::*;struct M{a:u64,v:u32}impl Mmio32 for M{fn read32(&mut self,_:u64)->u32{0}fn write32(&mut self,a:u64,v:u32){self.a=a;self.v=v}}#[test]fn pull(){let mut m=M{a:0,v:0};set_pull_raw(&mut m,0x1000,0,13,2).unwrap();assert_eq!(m.a,0x5028);assert_eq!(m.v,0x0C000800);}}
