...
/// Stage 13: common memory/cache and final-transfer boundaries used by multiple
/// reconstructed boot components.
pub trait MemoryTransfer{fn copy_words_exact(&mut self,dst:u64,src:u64,words:u32);}
pub trait CacheRangeOps{fn clean_invalidate_range(&mut self,addr:u64,bytes:u32);}
